...
from file_upload import Datasets, get_data_file, save_json
...
save_json(fhir_resources, "test_05/results/fhir_resources.json")
print("\n\n")
...
# save the .csv file
vis_timeseries.to_csv("test_05/results/VIS_timeseries.csv")
print("\n\n")
